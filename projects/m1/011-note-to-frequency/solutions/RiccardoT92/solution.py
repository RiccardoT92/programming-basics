...
Ottava=input("scrivi il valore dell'ottava: ")
NOTA=input("scrivi una nota: ")
#inizializzo il dizionario impostando nota:chiave, valore:frequenza
dicto = {"C4":261.63,"D4":293.66,"E4":329.63,"F4":349.23,"G4":392.00,"A4":440.00,"B4":493.88}
#eseguo il controllo
if NOTA in dicto:
   print("la frequenza associata a questa nota è: ",dicto[NOTA])
   #eseguo la formula che ha suggerito  il problema
   freq_after=dicto[NOTA]//2**(4-int(Ottava))
   print("frequenza della nota in base all'ottava: ",freq_after)